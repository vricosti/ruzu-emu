...
pub fn surface_format(format: PixelFormat) -> Option<MetalFormat> {
    ...
    let resolved = match format {
        ...
        A1R5G5B5Unorm => MetalFormat::native(MTLPixelFormat::BGR5A1Unorm),
        ...
        A1B5G5R5Unorm => MetalFormat::converted(MTLPixelFormat::BGR5A1Unorm),
        // R5G5B5A1-packed storage; the sampled view applies Eden's SwapSpecial.
        A5B5G5R1Unorm => MetalFormat::native(MTLPixelFormat::A1BGR5Unorm),
