...
mod tests {
    ...
    fn generated_vulkan_shaders_are_spirv_modules() {
        ...
        for module in [
            ...
            CONVERT_MSAA_TO_NON_MSAA_SINT_FRAG_SPV,
            CONVERT_MSAA_TO_NON_MSAA_UINT_FRAG_SPV,
            CONVERT_MSAA_TO_NON_MSAA_DEPTH_FRAG_SPV,
            CONVERT_MSAA_TO_NON_MSAA_DEPTH_STENCIL_FRAG_SPV,
            CONVERT_NON_MSAA_TO_MSAA_FRAG_SPV,
            CONVERT_NON_MSAA_TO_MSAA_SINT_FRAG_SPV,
            CONVERT_NON_MSAA_TO_MSAA_UINT_FRAG_SPV,
            CONVERT_NON_MSAA_TO_MSAA_DEPTH_FRAG_SPV,
            CONVERT_NON_MSAA_TO_MSAA_DEPTH_STENCIL_FRAG_SPV,
