...
pub fn memory_read_8(callbacks: &dyn UserCallbacks, vaddr: u64) -> u64 {
    callbacks.memory_read_8(vaddr as u32) as u64
}

#[inline]
pub fn memory_read_16(callbacks: &dyn UserCallbacks, vaddr: u64) -> u64 {
    callbacks.memory_read_16(vaddr as u32) as u64
}

#[inline]
pub fn memory_read_32(callbacks: &dyn UserCallbacks, vaddr: u64) -> u64 {
    callbacks.memory_read_32(vaddr as u32) as u64
}
...
pub fn exclusive_write_8(
    ...
    callbacks.memory_write_exclusive_8(vaddr as u32, value as u8, expected) as u64 ^ 1
}
...
pub fn exclusive_write_16(
    ...
    callbacks.memory_write_exclusive_16(vaddr as u32, value as u16, expected) as u64 ^ 1
}
...
pub fn exclusive_write_32(
    ...
    callbacks.memory_write_exclusive_32(vaddr as u32, value as u32, expected) as u64 ^ 1
}
...
pub fn exclusive_write_64(
    ...
    callbacks.memory_write_exclusive_64(vaddr as u32, value, expected) as u64 ^ 1
}
